...
const Artistas = {
  kurtcobain: require('./assets/img/kurtcobain.png'),
  chriscornell: require('./assets/img/cornell.png'),
  freddiemercury: require('./assets/img/mercury.png')
}
...
export default function App() {
  ...
  return (
    <View style={{ flex: 1, padding: 24, marginTop: 60 }}>
      ...
      <Pressable style={{
        backgroundColor: 'purple', padding: 10, justifyContent: 'center',
        marginTop: 20
      }} onPress={pesquisa}>
